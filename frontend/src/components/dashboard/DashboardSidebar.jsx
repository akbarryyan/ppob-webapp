...
const DashboardSidebar = ({
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-64 bg-white/95 backdrop-blur-xl border-r border-gray-200/50 shadow-xl transform ${
    ...
    >
      ...
      <div className="absolute bottom-20 left-4 right-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-4">

          ...
          return (
            ...
            >
              <div className="p-6">
                ...
                <p className={`text-sm font-semibold ${colors.textDark} mb-2`}>
                  {method.value}
                </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 overflow-hidden">
            <div className="p-6 border-b border-gray-200/50">
              <h3 className="text-xl font-bold text-gray-900 flex items-center">
                <MapPinIcon className="w-6 h-6 mr-3 text-red-600" />
                Kantor Kami
              </h3>
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <button className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-red-50 hover:bg-red-100 text-red-600 rounded-2xl transition-colors duration-200">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 overflow-hidden">
            ...
            <div className="p-6">
              ...
              <button className="w-full mt-4 px-4 py-3 bg-yellow-50 hover:bg-yellow-100 text-yellow-600 rounded-2xl transition-colors duration-200 text-sm font-medium">
                Lihat Semua FAQ
              </button>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-3xl p-6 border border-orange-200/50">
            <div className="text-center">
              ...
              <h4 className="font-bold text-orange-900 text-lg mb-1">4.9/5</h4>
              <p className="text-sm text-orange-700 mb-3">Dari 2,547 reviews</p>
